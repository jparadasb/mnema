...
| boto3             | 1.39.14     | Apache Software License              | https://github.com/boto/boto3                              |
| botocore          | 1.39.17     | Apache Software License              | https://github.com/boto/botocore                           |
...
| filelock          | 3.32.0      | MIT License                          | https://github.com/tox-dev/py-filelock                     |
| greenlet          | 3.5.4       | UNKNOWN                              | https://greenlet.readthedocs.io                            |
...
| mnema             | 0.1.0       | UNKNOWN                              | UNKNOWN                                                    |
| mypy              | 1.16.1      | MIT License                          | https://www.mypy-lang.org/                                 |
...
| pathspec          | 1.1.1       | Mozilla Public License 2.0 (MPL 2.0) | UNKNOWN                                                    |
| playwright        | 1.61.0      | Apache-2.0                           | https://github.com/microsoft/playwright-python             |
| platformdirs      | 4.11.0      | MIT License                          | https://github.com/tox-dev/platformdirs                    |
...
| pydantic          | 2.11.7      | MIT License                          | https://github.com/pydantic/pydantic                       |
...
| pytest            | 8.4.1       | MIT License                          | https://docs.pytest.org/en/latest/                         |
| pytest-asyncio    | 1.0.0       | UNKNOWN                              | https://github.com/pytest-dev/pytest-asyncio               |
| pytest-cov        | 6.2.1       | MIT                                  | https://github.com/pytest-dev/pytest-cov                   |
| python-dateutil   | 2.9.0.post0 | Apache Software License; BSD License | https://github.com/dateutil/dateutil                       |
| python-discovery  | 1.5.0       | MIT License                          | https://github.com/tox-dev/python-discovery                |
...
| ruff              | 0.12.4      | MIT License                          | https://docs.astral.sh/ruff                                |
...
| starlette         | 0.47.3      | BSD License                          | https://github.com/encode/starlette                        |
...
| virtualenv        | 21.7.0      | MIT License                          | https://github.com/pypa/virtualenv                         |
| watchfiles        | 1.2.0       | MIT License                          | https://github.com/samuelcolvin/watchfiles                 |
| websockets        | 16.1.1      | UNKNOWN                              | https://github.com/python-websockets/websockets            |
